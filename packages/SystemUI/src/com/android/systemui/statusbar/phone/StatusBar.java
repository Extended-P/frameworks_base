...
public class StatusBar extends SystemUI implements DemoMode,
   ...
   /** private FlashlightController mFlashlightController; **/
    ...
    public void start() {
        ...
        mExtraSettingsObserver.observe();
        mExtraSettingsObserver.update();
    ...
    public boolean isUsingMemeTheme() {
        OverlayInfo themeInfo = null;
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.meme",
                    mLockscreenUserManager.getCurrentUserId());
        } catch (RemoteException e) {
            e.printStackTrace();
        }
   ...
   /**  final boolean wallpaperWantsDarkTheme = systemColors != null
        ...
        if (isUsingMemeTheme() != useMemeTheme) {
            mUiOffloadThread.submit(() -> {
                try {
                    mOverlayManager.setEnabled("com.android.system.theme.meme",
                            useMemeTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.settings.theme.meme",
                            useMemeTheme, mLockscreenUserManager.getCurrentUserId());
    ...
    public void updateAccents() {
        ...
        if (accentSetting == 0) {
            ...
            try {
                mOverlayManager.setEnabled("com.google.android.theme.cyan",
                        true, mCurrentUserId);
            } catch (RemoteException e) {
                Log.w(TAG, "Can't change theme", e);
            }
            ...
            try {
                mOverlayManager.setEnabled("com.google.android.theme.flare",
                        true, mCurrentUserId);
            } catch (RemoteException e) {
                Log.w(TAG, "Can't change theme", e);
            }
            ...
            try {
                mOverlayManager.setEnabled("com.google.android.theme.purpink",
                        true, mCurrentUserId);
            } catch (RemoteException e) {
                Log.w(TAG, "Can't change theme", e);
            }
            ...
            try {
                mOverlayManager.setEnabled("com.google.android.theme.quepal",
                        true, mCurrentUserId);
            } catch (RemoteException e) {
                Log.w(TAG, "Can't change theme", e);
            }
            ...
            try {
                mOverlayManager.setEnabled("com.google.android.theme.sunset",
                        true, mCurrentUserId);
            } catch (RemoteException e) {
                Log.w(TAG, "Can't change theme", e);
            }
            ...
            try {
                mOverlayManager.setEnabled("com.google.android.theme.veryblue",
                        true, mCurrentUserId);
            } catch (RemoteException e) {
                Log.w(TAG, "Can't change theme", e);
            }
